...
* **Search Autocomplete & Verification**:
  * *Prompt*: *"Design a search console that queries Alpha Vantage SYMBOL_SEARCH and falls back to Serper organic query search results, combining and ranking them by match relevance."*
